...
export const KUI_COLOR_BACKGROUND_NEUTRAL_WEAKEST = "#eceff3"; // Weakest background color for neutral elements (gray.10).
...
export const KUI_COLOR_BORDER_NEUTRAL_WEAKEST = "#eceff3"; // Weakest border color for neutral elements (gray.10)
...
export const KUI_COLOR_TEXT_NEUTRAL_WEAKEST = "#eceff3"; // Weakest text color for neutral elements (gray.10).
