...
export const PROPERTY_TOKEN_MAP = {
  background: ['color-background', 'color-brand', 'status-color'],
  'background-color': ['color-background', 'color-brand', 'status-color'],
  'background-size': [],
  border: ['border-radius', 'border-width', 'color-border', 'color-brand'],
  'border-bottom': ['border-radius', 'border-width', 'color-border', 'color-brand'],
  'border-bottom-color': ['color-border', 'color-brand'],
  'border-bottom-left-radius': ['border-radius'],
  'border-bottom-right-radius': ['border-radius'],
  'border-bottom-width': ['border-width'],
  'border-color': ['color-border', 'color-brand'],
  'border-left': ['border-radius', 'border-width', 'color-border', 'color-brand'],
  'border-left-color': ['color-border', 'color-brand'],
  'border-left-width': ['border-width'],
  'border-radius': ['border-radius'],
  'border-right': ['border-radius', 'border-width', 'color-border', 'color-brand'],
  'border-right-color': ['color-border', 'color-brand'],
  'border-right-width': ['border-width'],
  'border-spacing': ['space'],
  'border-top': ['border-radius', 'border-width', 'color-border', 'color-brand'],
  'border-top-color': ['color-border', 'color-brand'],
  'border-top-left-radius': ['border-radius'],
  'border-top-right-radius': ['border-radius'],
  'border-top-width': ['border-width'],
  'border-width': ['border-width'],
  bottom: [],
  'box-shadow': ['border-width', 'color-border', 'color-brand', 'shadow'],
  color: ['color-text', 'icon-color', 'status-color', 'color-brand'],
  'column-gap': ['space'],
  'column-width': [],
  fill: ['color-text', 'color-brand', 'status-color'],
  ...
  'outline-color': ['color-border', 'color-brand'],
  ...
  right: [],
  'row-gap': ['space'],
  stroke: ['color-text', 'color-brand', 'status-color'],
